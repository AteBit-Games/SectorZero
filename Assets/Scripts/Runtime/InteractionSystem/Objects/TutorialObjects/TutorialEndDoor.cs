...
namespace Runtime.InteractionSystem.Objects.TutorialObjects
{
    ...
    public class TutorialEndDoor : MonoBehaviour, IPersistant
    {
        [SerializeField] private Sound openSound;
        [SerializeField] private Sound closeSound;
        [SerializeField] private Sound buzzSound;
        ...
        {
            GameManager.Instance.SoundSystem.PlayOneShot(buzzSound, _audioSource);
